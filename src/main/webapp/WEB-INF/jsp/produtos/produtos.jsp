        ...
        <div class="col-lg-4 col-sm-6 mb-4">
          <div class="portfolio-item">
            ...
            <div class="portfolio-caption">
              <div class="portfolio-caption-heading">${produto.valorDinheiro}</div>
                ...
                <div class="row justify-content-center">
                  <div class="col-lg-8">
                    <div class="modal-body">
                      ...
                      <h2 class="text-uppercase">${produto.valorDinheiro}</h2>
                      ...
                      <ul class="list-inline">
                        <li>Promoção valida Até: ${produto.dataValidadeFormatado}</li>                     
                      </ul>
                      <div class="d-flex justify-content-center">
                        ...
                        <div class="form-group mb-md-0 ml-2">
                          <button class="btn btn-info btn-xl text-uppercase js-scroll-trigger" onclick="window.location.href='formProduto'" >Editar</button>
                        </div>
                      </div>
    ...
    <div class="container">
      <div class="row align-items-center">
        <div class="col-lg-4 text-lg-left">
          Copyright Â© SenaiCommerce 2021
        </div>
