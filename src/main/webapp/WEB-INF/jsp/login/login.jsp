        ...
        <section class="page-section" id="beneficios">
            <div class="container">
                <div class="text-center">
                    ...
                    <h3 class="section-subheading text-muted">Aqui no shoppingCommerce você encontra os melhores preços!</h3>
                </div>
                <div class="row text-center">
                    ...
                    <div class="col-md-4">
                        ...
                        <p class="text-muted">Compra segura e em parceiros confiaveis. Caso não receba o produto o reembolso imediato!</p>
                    </div>
                </div>
            </div>
        </section>
